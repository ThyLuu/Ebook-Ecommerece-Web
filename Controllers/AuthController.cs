...
public class AuthController : Controller{
    ...
    public async Task<IActionResult> Login(LoginModel obj)
    {
        Member? member = context.Members
            .Where(p => p.Email == obj.Eml && p.Password == Helper.Hash(obj.Pwd))
        ...
        // Đảm bảo lưu đúng MemberId vào Claims, không phải Name
        List<Claim> claims = new List<Claim>
        {
            new Claim(ClaimTypes.NameIdentifier, member.MemberId),  // Lưu MemberId vào Claims
        ...
        Console.WriteLine($"Logged in MemberId: {member.MemberId}");
